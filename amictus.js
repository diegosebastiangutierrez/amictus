...
document.addEventListener('DOMContentLoaded',()=>{
 ...
 if(CHROME.topbar){
  ...
  t.innerHTML='<div class="contenedor">'+
   ...
   '<div><h4>Portal</h4><a href="index.html#catalogo">Catálogo</a><a href="index.html#manifiesto">Manifiesto</a><a href="autor.html">El autor</a><a href="prensa.html">Prensa & sponsors</a><a href="el-hilo.html">El Hilo</a><a href="sitemap.html">Mapa del sitio</a></div>'+'<div><h4>Colección</h4><a href="volumen-01-codex.html">VOL I · CODEX</a><a href="volumen-02-praxis.html">VOL II · PRAXIS</a><a href="volumen-03-expansion.html">VOL III · EXPANSION</a><a href="volumen-04-mundus.html">VOL IV · MUNDUS</a><a href="volumen-05-mercatus.html">VOL V · MERCATUS</a><a href="volumen-06-opus.html">VOL VI · OPUS</a><a href="index.html#cura">CURA gratis</a></div>'+
    '<div><h4>Recursos</h4><a href="herramientas.html">Herramientas</a><a href="glosario.html">Glosario</a><a href="qrs.html">Índice QR</a><a href="fuentes.html">Fuentes</a><a href="museos.html">Museos</a><a href="laminas.html">Láminas</a><a href="herramientas/libros-de-moda.html">Commprar libros de moda</a><a href="sitemap.html">Mapa del sitio</a></div>'+'</div>'+  
   '</div></div>';
 ...
 if(CHROME.footer){
  ...
  f.innerHTML='<div class="contenedor"><p class="footer-marca">Amictus</p>'+
   ...
   '<div><h4>Recursos</h4><a href="herramientas.html">Herramientas</a><a href="glosario.html">Glosario</a><a href="qrs.html">Índice QR</a><a href="fuentes.html">Fuentes verificadas</a><a href="museos.html">Museos Open Access</a><a href="laminas.html">Láminas</a><a href="herramientas/libros-de-moda.html">Comprar Libros de moda</a></div>'+
   '<div><h4>Portal</h4><a href="index.html#catalogo">Catálogo completo</a><a href="index.html#manifiesto">Manifiesto</a><a href="autor.html">El autor</a><a href="prensa.html">Prensa & sponsors</a><a href="el-hilo.html">El Hilo</a><a href="sitemap.html">Mapa del sitio</a></div>'+
   '</div>'+
...
/* ============================================================
   ...
   los links internos de topbar/footer/countdown con los ../ necesarios.
   ============================================================ */
  function raiz(){
  ...
  function arreglar(){
    var sel=document.querySelectorAll('.topbar a, footer a, .footer a, section.countdown a');
